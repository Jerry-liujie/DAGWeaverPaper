...
\textcolor{red}{[PLACEHOLDER] To isolate the contribution of the structural analyses in Section~\ref{sec:candidate-identification}, we compare \tool{} against a variant that bypasses dataflow-based candidate selection and passes every model group (or a randomly sampled set) to the LLM refactoring stage. The comparison is on Tuva and measures final frequency-weighted slot improvement and total LLM tokens consumed. Numbers TBD.}
