...
\begin{enumerate}
    ...
    \item How much does each component of \tool{}'s architecture contribute to the overall gain? We ablate the three \tofix{implementation dimensions} (refactoring, materialization, and frequency) and the dataflow-driven targeting that feeds the LLM stage.
