...
\begin{enumerate}
    ...
    \item How much does each component of \tool{}'s architecture contribute to the overall gain? We ablate the three  implementation dimensions  (refactoring, materialization, and frequency) and the dataflow-driven targeting that feeds the LLM stage.
...
\begin{table}[tb]
\centering
\caption{\tool{}'s coverage of Tuva's 255 models. }
\inv
\label{tab:coverage}
\small
\begin{tabular}{lr}
